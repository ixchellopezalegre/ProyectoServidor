...
<body>
	...
	<a href="/app/producto/alta" class="btn btn-primary btn-sm" >Nuevo Producto</a></td>
	</sec:authorize>
	...
	<c:forEach var="ele" items="${listaTodos }" >
		<tr>
			...
			<td><a href="/app/producto/verUno/${ele.codigo}" class="btn btn-success btn-sm">Ver detalle</a>
			 <sec:authorize access="hasAnyAuthority('ROLE_GESTOR','ROLE_ADMINISTRADOR')">
			<a href="/app/producto/editar/${ele.codigo}" class="btn btn-success btn-sm">Modificar</a> 
			 <a href="/app/producto/eliminar/${ele.codigo}" class="btn btn-danger btn-sm">Eliminar</a></td>
			  </sec:authorize>
		</tr>
	</c:forEach>
	</table>
